...
<html>
  ...
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
        ...
        <link rel="shortcut icon" href="<?= base_url('assets/img/logotresss.png') ?>" type="image/x-icon">
        <link rel="shortcut icon" href="<?= base_url('assets/img/logotresss.png') ?>" type="image/x-icon">
        <!-- Si deseas que funcione en dispositivos de Apple -->
        <link rel="apple-touch-icon" href="<?= base_url('assets/img/logotresss.png') ?>">
        <link rel="apple-touch-icon" sizes="152x152" href="<?= base_url('assets/img/logotresss.png') ?>">
        <link rel="apple-touch-icon" sizes="180x180" href="<?= base_url('assets/img/logotresss.png') ?>">
        <!-- Si deseas que funcione en dispositivos Android -->
        <link rel="icon" sizes="192x192" href="<?= base_url('assets/img/logotresss.png') ?>">
        <!-- Si deseas que funcione en dispositivos Windows -->
        <meta name="msapplication-square70x70logo" content="<?= base_url('assets/img/logotresss.png') ?>">
        <meta name="msapplication-square150x150logo" content="<?= base_url('assets/img/logotresss.png') ?>">
        <meta name="msapplication-wide310x150logo" content="<?= base_url('assets/img/logotresss.png') ?>">
        <meta name="msapplication-square310x310logo" content="<?= base_url('assets/img/logotresss.png') ?>">
    ...
    <?php if($logged_in == 1): ?>
        ...
        <?php else: ?>
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <p class="btn"><?php echo anchor('usuarios', 'Usuarios') ?></p>
                    <p class="btn"><?php echo anchor('productos', 'Productos') ?></p>
                    <p class="btn"><?php echo anchor('consultas', 'Consultas') ?></p>
                    <p class="btn"><?php echo anchor('admin/compras', 'Compras') ?></p>
                    <p class="btn"><a href="<?= base_url('/logout') ?>">Cerrar Sesión</a></p>
                </ul>
            </div>
            <?php echo anchor('index', 'INICIO') ?>
...
document.addEventListener('DOMContentLoaded', function() {
    const scrollButton = document.querySelector('.button-scroll-up');
